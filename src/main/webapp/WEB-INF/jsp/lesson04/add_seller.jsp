	...
	<div class="container">
		...
		<form method="post" action="/lesson04/quiz01/add_seller">
			...
			<label for="profileImageUrl"><b>프로필 사진 Url</b></label>
				<input type="text" id="profileImageUrl" name="profileImageUrl" class="form-control col-9" placeholder="이미지 url 주소를 입력하세요.">
			</div>
			<div class="form-group">
			<label for="temperature"><b>온도</b></label>
				<input type="text" id="temperature" name="temperature" class="form-control col-3" placeholder="예)36.5">
			</div>
